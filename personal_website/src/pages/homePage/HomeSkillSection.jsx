...
const HomeSkillSection = () => {
    const vueSkillList = [
        { text: '使用 Vite、create-vue 開發 Vue3 專案' },
        { text: '使用 options api 與 composition api 撰寫程式碼' },
        { text: '使用 vue-router 管理路由與身分驗證' },
        { text: '使用 pinia 設置全站跨元件狀態管理' },
        { text: '使用 vee-validate + yup 驗證表單資料' },
    ];
    ...
    const reactSkillList = [
        ...
        { text: '使用 React-Hook-Form 驗證表單資料' },
    ];
